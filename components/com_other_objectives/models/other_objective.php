 ...
 * @since  1.6
 */
class Other_objectivesModelOther_objective extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_other_objectives')) && (!$user->authorise('core.edit', 'com_other_objectives')))
		{
	...
	public function getItem($id = null)
	{
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
				...
				if ($published = $this->getState('filter.published'))
				{
					...
					{
						throw new Exception(JText::_('COM_OTHER_OBJECTIVES_ITEM_NOT_LOADED'), 403);
					}
				}
		...
		if (isset($this->_item->modified_by))
		{
			$this->_item->modified_by_name = Factory::getUser($this->_item->modified_by)->name;
					...
					$this->_item->objective_achieved = JText::_('COM_OTHER_OBJECTIVES_OTHER_OBJECTIVES_OBJECTIVE_ACHIEVED_OPTION_' . $this->_item->objective_achieved);
