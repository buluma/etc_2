...
<div class="brandstock-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-brandstock"
			  action="<?php echo JRoute::_('index.php?option=com_bts_products&task=brandstock.save'); ?>"
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_bts_products&task=brandstockform.cancel'); ?>"
