 ...
 * @since  1.6
 */
class ObjectivesModelObjectives extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_objectives')) && (!$user->authorise('core.edit', 'com_objectives')))
		{
		...
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
				...
				if ($published = $this->getState('filter.published'))
				{
					...
					{
						throw new Exception(JText::_('COM_OBJECTIVES_ITEM_NOT_LOADED'), 403);
					}
				}
