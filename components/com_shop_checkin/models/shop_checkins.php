...
class Shop_checkinModelShop_checkins extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getUser()->authorise('core.edit', 'com_shop_checkin'))
		{
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
			...
			if (isset($item->checkin_place))
			{
				$values    = explode(',', $item->checkin_place);
				$textValue = array();
				...
				$item->checkin_place = !empty($textValue) ? implode(', ', $textValue) : $item->checkin_place;
			}

			if (isset($item->checkout_place))
			{
				$values    = explode(',', $item->checkout_place);
				$textValue = array();
				...
				$item->checkout_place = !empty($textValue) ? implode(', ', $textValue) : $item->checkout_place;
			}
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_SHOP_CHECKIN_SEARCH_FILTER_DATE_FORMAT"), "warning");
