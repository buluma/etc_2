...
<div class="outlet-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-outlet"
			  action="<?php echo JRoute::_('index.php?option=com_outlets&task=outlet.save'); ?>"
	...
	<input type="hidden" name="jform[user_id]" value="<?php echo $this->item->user_id; ?>" />
				<div class="fltlft" <?php if (!JFactory::getUser()->authorise('core.admin','outlets')): ?> style="display:none;" <?php endif; ?> >
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_outlets&task=outletform.cancel'); ?>"
