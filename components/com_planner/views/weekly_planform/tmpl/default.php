...
<div class="weekly_plan-edit front-end-edit">
	<?php if (!$canEdit) : ?>
		<h3>
	...
	<?php else : ?>
		...
		<form id="form-weekly_plan"
			  action="<?php echo JRoute::_('index.php?option=com_planner&task=weekly_plan.save'); ?>"
	...
	<input type="hidden" name="jform[first_insert]" value="<?php echo $this->item->first_insert; ?>" />
			...
			<div class="control-group">
				<div class="controls">
					...
					<?php endif; ?>
					<a class="btn"
					   href="<?php echo JRoute::_('index.php?option=com_planner&task=weekly_planform.cancel'); ?>"
