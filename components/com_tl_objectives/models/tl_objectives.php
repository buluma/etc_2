...
/**
 * Methods supporting a list of Tl_objectives records.
 *
 * @since  1.6
 */
class Tl_objectivesModelTl_objectives extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__tl_objectives` AS a');
		...
		if (!Factory::getUser()->authorise('core.edit', 'com_tl_objectives'))
		{
	...
	public function getItems()
	{
		...
		{
				$item->objective_achieved = empty($item->objective_achieved) ? '' : JText::_('COM_TL_OBJECTIVES_TL_OBJECTIVES_OBJECTIVE_ACHIEVED_OPTION_' . strtoupper($item->objective_achieved));
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_TL_OBJECTIVES_SEARCH_FILTER_DATE_FORMAT"), "warning");
