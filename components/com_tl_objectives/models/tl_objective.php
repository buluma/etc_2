 ...
 * @since  1.6
 */
class Tl_objectivesModelTl_objective extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_tl_objectives')) && (!$user->authorise('core.edit', 'com_tl_objectives')))
		{
	...
	public function getItem($id = null)
	{
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
				...
				if ($published = $this->getState('filter.published'))
				{
					...
					{
						throw new Exception(JText::_('COM_TL_OBJECTIVES_ITEM_NOT_LOADED'), 403);
					}
				}
		...
		if (isset($this->_item->modified_by))
		{
			$this->_item->modified_by_name = Factory::getUser($this->_item->modified_by)->name;
					...
					$this->_item->objective_achieved = JText::_('COM_TL_OBJECTIVES_TL_OBJECTIVES_OBJECTIVE_ACHIEVED_OPTION_' . $this->_item->objective_achieved);
