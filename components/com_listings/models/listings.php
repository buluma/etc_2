...
class ListingsModelListings extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		if (!Factory::getUser()->authorise('core.edit', 'com_listings'))
		{
	...
	public function getItems()
	{
		...
		foreach ($items as $item)
		{
			...
			if (isset($item->listing))
			{
				...
				$item->listing = !empty($textValue) ? implode(', ', $textValue) : $item->listing;
			}
				$item->listed = empty($item->listed) ? '' : JText::_('COM_LISTINGS_LISTINGS_LISTED_OPTION_' . strtoupper($item->listed));
	...
	protected function loadFormData()
	{
		...
		if ($error_dateformat)
		{
			$app->enqueueMessage(JText::_("COM_LISTINGS_SEARCH_FILTER_DATE_FORMAT"), "warning");
