...
/**
 * focus_area Table class
 *
 * @since  1.6
 */
class FocusareasTablefocus_area extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'FocusareasTablefocus_area', array('typeAlias' => 'com_focusareas.focus_area'));
		parent::__construct('#__focusareas', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_focusareas.focus_area.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_focusareas/access.xml',
				"/access/section[@name='focus_area']/"
			);
			$default_actions = JAccess::getAssetRules('com_focusareas.focus_area.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_focusareas.focus_area.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_focusareas');
