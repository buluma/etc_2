...
$document->addStyleSheet(JUri::root() . 'media/com_perfect_checklist/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_perfect_checklist&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="checklist-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PERFECT_CHECKLIST_TITLE_CHECKLIST', true)); ?>
		<div class="row-fluid">
