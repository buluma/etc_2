 ...
 * @since  1.6
 */
class Location_visitsTablelocation extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'Location_visitsTablelocation', array('typeAlias' => 'com_location_visits.location'));
		parent::__construct('#__locations', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_location_visits.location.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_location_visits/access.xml',
				"/access/section[@name='location']/"
			);
			$default_actions = JAccess::getAssetRules('com_location_visits.location.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_location_visits.location.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_location_visits');
