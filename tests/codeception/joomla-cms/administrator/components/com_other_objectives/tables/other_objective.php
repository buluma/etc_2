...
/**
 * other_objective Table class
 *
 * @since  1.6
 */
class Other_objectivesTableother_objective extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'Other_objectivesTableother_objective', array('typeAlias' => 'com_other_objectives.other_objective'));
		parent::__construct('#__other_objectives', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_other_objectives.other_objective.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_other_objectives/access.xml',
				"/access/section[@name='other_objective']/"
			);
			$default_actions = JAccess::getAssetRules('com_other_objectives.other_objective.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_other_objectives.other_objective.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_other_objectives');
