...
/**
 * Methods supporting a list of Price_survey records.
 *
 * @since  1.6
 */
class Price_surveyModelPiss extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Filtering week
		$this->setState('filter.week', $app->getUserStateFromRequest($this->context.'.filter.week', 'filter_week', '', 'string'));
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_price_survey');
	...
	protected function getListQuery()
	{
		...
		$query->from('`#__price_survey` AS a');
