...
$document->addStyleSheet(JUri::root() . 'media/com_price_survey/css/form.css');
?>
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'pis.cancel') {
			Joomla.submitform(task, document.getElementById('pis-form'));
		}
		else {
			
			if (task != 'pis.cancel' && document.formvalidator.isValid(document.id('pis-form'))) {
...
<form
	action="<?php echo JRoute::_('index.php?option=com_price_survey&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="pis-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PRICE_SURVEY_TITLE_PIS', true)); ?>
		<div class="row-fluid">
