 ...
 * @since  1.6
 */
class PhotosModelPhotos extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_photos');
	...
	public function getItems()
	{
		...
		foreach ($items as $oneItem)
		{
			...
			if (isset($oneItem->store_server_id))
			{
				$values    = explode(',', $oneItem->store_server_id);
				$textValue = array();
				...
				$oneItem->store_server_id = !empty($textValue) ? implode(', ', $textValue) : $oneItem->store_server_id;
			}
		}
