	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="productList">
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PRODUCTS_PRODUCTS_PUBLISHED', 'a.`published`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PRODUCTS_PRODUCTS_MUST_HAVE', 'a.`must_have`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
