 ...
 * @since  1.6
 */
class PromotionsTablepromotion extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'PromotionsTablepromotion', array('typeAlias' => 'com_promotions.promotion'));
		parent::__construct('#__promotions', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_promotions.promotion.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_promotions/access.xml',
				"/access/section[@name='promotion']/"
			);
			$default_actions = JAccess::getAssetRules('com_promotions.promotion.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_promotions.promotion.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_promotions');
