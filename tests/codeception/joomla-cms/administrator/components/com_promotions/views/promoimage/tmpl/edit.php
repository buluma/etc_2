...
$document->addStyleSheet(JUri::root() . 'media/com_promotions/css/form.css');
?>
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'promoimage.cancel') {
			Joomla.submitform(task, document.getElementById('promoimage-form'));
		}
		else {
			
			if (task != 'promoimage.cancel' && document.formvalidator.isValid(document.id('promoimage-form'))) {
...
<form
	action="<?php echo JRoute::_('index.php?option=com_promotions&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="promoimage-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PROMOTIONS_TITLE_PROMOIMAGE', true)); ?>
		<div class="row-fluid">
