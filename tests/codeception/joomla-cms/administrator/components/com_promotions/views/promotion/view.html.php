 ...
 * @since  1.6
 */
class PromotionsViewPromotion extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		{
			JToolBarHelper::custom('promotion.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
		}

		// Button for version control
		if ($this->state->params->get('save_history', 1) && $user->authorise('core.edit')) {
			JToolbarHelper::versions('com_promotions.promotion', $this->item->id);
		}
