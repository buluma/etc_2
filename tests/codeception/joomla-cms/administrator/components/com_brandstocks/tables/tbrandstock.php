...
/**
 * tbrandstock Table class
 *
 * @since  1.6
 */
class BrandstocksTabletbrandstock extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'BrandstocksTabletbrandstock', array('typeAlias' => 'com_brandstocks.tbrandstock'));
		parent::__construct('#__brandstocks', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		// Support for empty date field: order_date
		if($array['order_date'] == '0000-00-00' )
		{
			$array['order_date'] = '';
		}
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_brandstocks.tbrandstock.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_brandstocks/access.xml',
				"/access/section[@name='tbrandstock']/"
			);
			$default_actions = JAccess::getAssetRules('com_brandstocks.tbrandstock.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_brandstocks.tbrandstock.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_brandstocks');
