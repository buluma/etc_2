...
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'weekly_plan.cancel') {
			Joomla.submitform(task, document.getElementById('weekly_plan-form'));
		}
		else {
			
			if (task != 'weekly_plan.cancel' && document.formvalidator.isValid(document.id('weekly_plan-form'))) {
...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="weekly_plan-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PLANNER_TITLE_WEEKLY_PLAN', true)); ?>
		<div class="row-fluid">
