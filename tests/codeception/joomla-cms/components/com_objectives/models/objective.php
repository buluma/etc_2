 ...
 * @since  1.6
 */
class ObjectivesModelObjective extends JModelItem
{
    public $_item;
	...
	public function getItem($id = null)
	{
		...
		if (!empty($this->_item->response_type))
		{
			$this->_item->response_type = JText::_('COM_OBJECTIVES_OBJECTIVES_RESPONSE_TYPE_OPTION_' . $this->_item->response_type);
		}
		...
		if (isset($this->_item->category) && $this->_item->category != '')
		{
			...
			$this->_item->category = !empty($result) ? implode(', ', $result) : '';
					...
					$this->_item->published = JText::_('COM_OBJECTIVES_OBJECTIVES_PUBLISHED_OPTION_' . $this->_item->published);
					$this->_item->deleted = JText::_('COM_OBJECTIVES_OBJECTIVES_DELETED_OPTION_' . $this->_item->deleted);
