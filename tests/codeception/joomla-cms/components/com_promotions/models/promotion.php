 ...
 * @since  1.6
 */
class PromotionsModelPromotion extends JModelItem
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_promotions')) && (!$user->authorise('core.edit', 'com_promotions')))
		{
		...
		if ($this->_item === null)
		{
			...
			if ($table->load($id))
			{
				...
				if ($published = $this->getState('filter.published'))
				{
					...
					{
						throw new Exception(JText::_('COM_PROMOTIONS_ITEM_NOT_LOADED'), 403);
					}
				}
