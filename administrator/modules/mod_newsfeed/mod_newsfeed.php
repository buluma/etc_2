...
JLoader::register('ModNewsFeedHelper', __DIR__ . '/helper.php');

$document = JFactory::getDocument();
$document->addStyleSheet('http://localhost:9000/startbootstrap-sb-admin/vendor/font-awesome/css/font-awesome.min.css');

$photos = ModNewsFeedHelper::getImages();
$locations = ModNewsFeedHelper::getVisits();
$newdate = ModNewsFeedHelper::time_elapsed_string($datetime);
// var_dump($newdate);
require JModuleHelper::getLayoutPath('mod_newsfeed', $params->get('layout', 'default'));
?>
