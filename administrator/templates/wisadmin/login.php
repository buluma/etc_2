...
$BottomIconText = $this->params->get('BottomIconText');
// Color Params
...
$doc->addStyleSheetVersion('templates/' . $this->template . '/css/' . ($this->params->get('logintype')) . '.css');
...
$WelcomeMessage  = $this->params->get('WelcomeMessage','Welcome');
...
<div class="bgpattern">
	<!-- Container -->
	<div class="container">
	<?php $ShowWelcomeMessage=$this->params->get('ShowWelcomeMessage');
	if ($ShowWelcomeMessage== 1) : ?><h1 class="register-title"><span><?php echo $WelcomeMessage; ?></span></h1><?php endif; ?>
		<div id="content">
			<!-- Begin Content -->
	...
	<div class="navbar<?php echo $template_is_light ? ' navbar-inverse' : ''; ?> navbar-fixed-bottom hidden-phone">
		...
		<a class="login icon-bottom hasTooltip" href="<?php echo $this->params->get('BottomIconLink'); ?>" target="_blank" title="<?php echo $BottomIconText; ?>"></a>
