...
/**
 * View class for a list of Listings.
 *
 * @since  1.6
 */
class ListingsViewListings extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		ListingsHelper::addSubmenu('listings');
	...
	protected function addToolbar()
	{
		...
		{
			JToolBarHelper::preferences('com_listings');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_listings&view=listings');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`listing`' => JText::_('COM_LISTINGS_LISTINGS_LISTING'),
			'a.`ordering`' => JText::_('JGRID_HEADING_ORDERING'),
			'a.`state`' => JText::_('JSTATUS'),
			'a.`listed`' => JText::_('COM_LISTINGS_LISTINGS_LISTED'),
			'a.`submitter`' => JText::_('COM_LISTINGS_LISTINGS_SUBMITTER'),
			'a.`user_id`' => JText::_('COM_LISTINGS_LISTINGS_USER_ID'),
			'a.`store`' => JText::_('COM_LISTINGS_LISTINGS_STORE'),
		);
	}
