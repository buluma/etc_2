...
/**
 * comp_activity Table class
 *
 * @since  1.6
 */
class Competitor_activitiesTablecomp_activity extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'Competitor_activitiesTablecomp_activity', array('typeAlias' => 'com_competitor_activities.comp_activity'));
		parent::__construct('#__competitor_activity', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_competitor_activities.comp_activity.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_competitor_activities/access.xml',
				"/access/section[@name='comp_activity']/"
			);
			$default_actions = JAccess::getAssetRules('com_competitor_activities.comp_activity.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_competitor_activities.comp_activity.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_competitor_activities');
