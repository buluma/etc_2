...
$document->addStyleSheet(JUri::root() . 'media/com_voc/css/form.css');
?>
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'voc.cancel') {
			Joomla.submitform(task, document.getElementById('voc-form'));
		}
		else {
			
			if (task != 'voc.cancel' && document.formvalidator.isValid(document.id('voc-form'))) {
...
<form
	action="<?php echo JRoute::_('index.php?option=com_voc&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="voc-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_VOC_TITLE_VOC', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('user_id'); ?>				<?php echo $this->form->renderField('last_sync_date'); ?>
				<input type="hidden" name="jform[insert_date]" value="<?php echo $this->item->insert_date; ?>" />
			...
			?>				<?php echo $this->form->renderField('category'); ?>
				...
				<?php echo $this->form->renderField('commentby'); ?>
				<?php echo $this->form->renderField('isurgent'); ?>
