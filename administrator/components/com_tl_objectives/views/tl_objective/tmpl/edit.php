...
$document->addStyleSheet(JUri::root() . 'media/com_tl_objectives/css/form.css');
?>
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'tl_objective.cancel') {
			Joomla.submitform(task, document.getElementById('tl_objective-form'));
		}
		else {
			
			if (task != 'tl_objective.cancel' && document.formvalidator.isValid(document.id('tl_objective-form'))) {
...
<form
	action="<?php echo JRoute::_('index.php?option=com_tl_objectives&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="tl_objective-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_TL_OBJECTIVES_TITLE_TL_OBJECTIVE', true)); ?>
		<div class="row-fluid">
