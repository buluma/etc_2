...
/**
 * tl_objective Table class
 *
 * @since  1.6
 */
class Tl_objectivesTabletl_objective extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'Tl_objectivesTabletl_objective', array('typeAlias' => 'com_tl_objectives.tl_objective'));
		parent::__construct('#__tl_objectives', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_tl_objectives.tl_objective.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_tl_objectives/access.xml',
				"/access/section[@name='tl_objective']/"
			);
			$default_actions = JAccess::getAssetRules('com_tl_objectives.tl_objective.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_tl_objectives.tl_objective.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_tl_objectives');
