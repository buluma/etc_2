...
/**
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_tl_objectives');
	...
	public function getItems()
	{
		...
		{
					$oneItem->objective_achieved = ($oneItem->objective_achieved == '') ? '' : JText::_('COM_TL_OBJECTIVES_TL_OBJECTIVES_OBJECTIVE_ACHIEVED_OPTION_' . strtoupper($oneItem->objective_achieved));
