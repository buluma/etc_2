 ...
 * @since  1.6
 */
class PromotionsModelPromotions extends JModelList
{
/**
	* Constructor.
	*
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Filtering end_date
		$this->setState('filter.end_date.from', $app->getUserStateFromRequest($this->context.'.filter.end_date.from', 'filter_from_end_date', '', 'string'));
		$this->setState('filter.end_date.to', $app->getUserStateFromRequest($this->context.'.filter.end_date.to', 'filter_to_end_date', '', 'string'));
