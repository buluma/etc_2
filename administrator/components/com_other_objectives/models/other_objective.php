 ...
 * @since  1.6
 */
class Other_objectivesModelOther_objective extends JModelAdmin
{
	/**
	 * @var      string    The prefix to use with controller messages.
	 * @since    1.6
	 */
	protected $text_prefix = 'COM_OTHER_OBJECTIVES';

	/**
	 * @var   	string  	Alias to manage history control
	 * @since   3.2
	 */
	public $typeAlias = 'com_other_objectives.other_objective';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
			'com_other_objectives.other_objective', 'other_objective',
			array('control' => 'jform',
				'load_data' => $loadData
			)
		);
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_other_objectives.edit.other_objective.data', array());
	...
	/**
	 * Method to duplicate an Other_objective
	 *
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_other_objectives'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__other_objectives');
				$max             = $db->loadResult();
