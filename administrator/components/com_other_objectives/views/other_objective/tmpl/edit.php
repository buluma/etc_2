...
$document->addStyleSheet(JUri::root() . 'media/com_other_objectives/css/form.css');
?>
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'other_objective.cancel') {
			Joomla.submitform(task, document.getElementById('other_objective-form'));
		}
		else {
			
			if (task != 'other_objective.cancel' && document.formvalidator.isValid(document.id('other_objective-form'))) {
...
<form
	action="<?php echo JRoute::_('index.php?option=com_other_objectives&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="other_objective-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_OTHER_OBJECTIVES_TITLE_OTHER_OBJECTIVE', true)); ?>
		<div class="row-fluid">
			<div class="span10 form-horizontal">
				...
				<?php echo $this->form->renderField('modified_by'); ?>				<?php echo $this->form->renderField('objective'); ?>
