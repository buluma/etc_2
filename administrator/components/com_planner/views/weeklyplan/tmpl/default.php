...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_planner&task=weeklyplan.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'weekly_plansList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

$sortFields = $this->getSortFields();
?>

<form action="<?php echo JRoute::_('index.php?option=com_planner&view=weeklyplan'); ?>" method="post"
			...
			<table class="table table-striped" id="weekly_plansList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PLANNER_WEEKLYPLAN_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PLANNER_WEEKLYPLAN_SUBMITTER', 'a.`submitter`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'weeklyplan.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
