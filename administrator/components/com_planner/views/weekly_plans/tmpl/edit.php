...
$document->addStyleSheet(JUri::root() . 'media/com_planner/css/form.css');
?>
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'weekly_plans.cancel') {
			Joomla.submitform(task, document.getElementById('weekly_plans-form'));
		}
		else {
			
			if (task != 'weekly_plans.cancel' && document.formvalidator.isValid(document.id('weekly_plans-form'))) {
...
<form
	action="<?php echo JRoute::_('index.php?option=com_planner&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="weekly_plans-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_PLANNER_TITLE_WEEKLY_PLANS', true)); ?>
		<div class="row-fluid">
