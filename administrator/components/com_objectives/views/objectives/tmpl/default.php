...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_objectives&task=objectives.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'objectiveList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
			...
			<table class="table table-striped" id="objectiveList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'objectives.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
...
<script>
	...
	jQuery(document).ready(function() {
	    jQuery('#objectiveList').DataTable( {
	        dom: 'Bfrtip',
	        buttons: [
