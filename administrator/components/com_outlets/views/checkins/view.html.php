 ...
 * @since  1.6
 */
class OutletsViewCheckins extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		OutletsHelper::addSubmenu('checkins');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_OUTLETS_TITLE_CHECKINS'), 'checkins.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_outlets&view=checkins');
	}
