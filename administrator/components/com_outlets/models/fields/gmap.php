...
class JFormFieldgmap extends JFormField
{
    ...
    {
        $params->latitude = -1.2920659;
        $params->longitude = 36.82194619999996;
        $params->addres = 'Nairobi, Kenya'; // Hardcode smart web studio coordinats if they are not set properly
    }
    ...
    protected function getJs($params)
    {
        $js = <<<__JS__
            ...
            jQuery(document).ready(function () {
                ...
                jQuery("#findelocation").click(function(){
