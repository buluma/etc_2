...
class AssetsViewAssets extends JViewLegacy
{
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`asset_type`' => JText::_('COM_ASSETS_ASSETS_ASSET_TYPE'),
			'a.`serial_number`' => JText::_('COM_ASSETS_ASSETS_SERIAL_NUMBER'),
			'a.`imagepath`' => JText::_('COM_ASSETS_ASSETS_IMAGEPATH'),
			'a.`ordering`' => JText::_('JGRID_HEADING_ORDERING'),
			'a.`state`' => JText::_('JSTATUS'),
			'a.`imagedate`' => JText::_('COM_ASSETS_ASSETS_IMAGEDATE'),
			'a.`submitter`' => JText::_('COM_ASSETS_ASSETS_SUBMITTER'),
			'a.`store`' => JText::_('COM_ASSETS_ASSETS_STORE'),
		);
	}
