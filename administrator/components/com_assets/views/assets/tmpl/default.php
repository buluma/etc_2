...
$canOrder  = $user->authorise('core.edit.state', 'com_assets');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_assets&task=assets.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_assets&view=assets'); ?>" method="post"
			...
			<table class="table table-striped" id="assetList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_ASSETS_ASSETS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_ASSETS_ASSETS_ASSET_TYPE', 'a.`asset_type`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canCreate  = $user->authorise('core.create', 'com_assets');
					$canEdit    = $user->authorise('core.edit', 'com_assets');
				...
				<?php if (isset($item->checked_out) && $item->checked_out && ($canEdit || $canChange)) : ?>
					<?php echo JHtml::_('jgrid.checkedout', $i, $item->uEditor, $item->checked_out_time, 'assets.', $canCheckin); ?>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_assets&task=asset.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->asset_type); ?></a>
				<?php else : ?>
					<?php echo $this->escape($item->asset_type); ?>
				<?php endif; ?>
