 ...
 * @since  1.6
 */
class AssetsTableasset extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'AssetsTableasset', array('typeAlias' => 'com_assets.asset'));
		parent::__construct('#__asset_management', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_assets.asset.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_assets/access.xml',
				"/access/section[@name='asset']/"
			);
			$default_actions = JAccess::getAssetRules('com_assets.asset.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_assets.asset.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_assets');
