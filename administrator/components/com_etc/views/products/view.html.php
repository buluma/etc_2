 ...
 * @since  1.6
 */
class EtcViewProducts extends JViewLegacy
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_ETC_TITLE_PRODUCTS'), 'products.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_etc&view=products');
	}
