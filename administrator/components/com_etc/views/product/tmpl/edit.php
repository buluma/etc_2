...
$document->addStyleSheet(JUri::root() . 'media/com_etc/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_etc&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="product-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_ETC_TITLE_PRODUCT', true)); ?>
		<div class="row-fluid">
