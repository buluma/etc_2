 ...
 * @since  1.6
 */
class Bts_productsViewBrandstocks extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		Bts_productsHelper::addSubmenu('brandstocks');
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_BTS_PRODUCTS_TITLE_BRANDSTOCKS'), 'brandstocks.png');
		...
		JHtmlSidebar::setAction('index.php?option=com_bts_products&view=brandstocks');
	}
