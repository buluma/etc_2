...
$document->addStyleSheet(JUri::root() . 'media/com_bts_products/css/form.css');
?>
<script type="text/javascript">
	...
	Joomla.submitbutton = function (task) {
		if (task == 'bts_product.cancel') {
			Joomla.submitform(task, document.getElementById('bts_product-form'));
		}
		else {
			
			if (task != 'bts_product.cancel' && document.formvalidator.isValid(document.id('bts_product-form'))) {
...
<form
	action="<?php echo JRoute::_('index.php?option=com_bts_products&layout=edit&id=' . (int) $this->item->id); ?>"
	method="post" enctype="multipart/form-data" name="adminForm" id="bts_product-form" class="form-validate">

	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'general')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', JText::_('COM_BTS_PRODUCTS_TITLE_BTS_PRODUCT', true)); ?>
		<div class="row-fluid">
