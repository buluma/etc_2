...
/**
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_bts_products');
		...
		foreach ($items as $oneItem)
		{
			...
			if (isset($oneItem->category))
			{
				...
				$oneItem->category = !empty($result) ? implode(', ', $result) : '';
					...
					$oneItem->published = JText::_('COM_BTS_PRODUCTS_BTS_PRODUCTS_PUBLISHED_OPTION_' . strtoupper($oneItem->published));
		}
