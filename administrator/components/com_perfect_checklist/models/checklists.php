...
/**
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		// Load the parameters.
		$params = JComponentHelper::getParams('com_perfect_checklist');
	...
	public function getItems()
	{
		...
		{
					$oneItem->sku_available = JText::_('COM_PERFECT_CHECKLIST_CHECKLISTS_SKU_AVAILABLE_OPTION_' . strtoupper($oneItem->sku_available));
