...
$document->addStyleSheet(JUri::root() . 'media/com_tasks/css/form.css');
?>
...
<form
	action="<?php echo JRoute::_('index.php?option=com_tasks&layout=edit&id=' . (int) $this->item->id); ?>"
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			<div class="span6 form-horizontal">
				...
				<?php echo $this->form->renderField('modified_by'); ?>				<?php echo $this->form->renderField('task'); ?>
