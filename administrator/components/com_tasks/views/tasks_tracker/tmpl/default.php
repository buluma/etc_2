...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_tasks/assets/css/tasks.css');
$document->addStyleSheet(JUri::root() . 'media/com_tasks/css/list.css');

$user      = JFactory::getUser();
$userId    = $user->get('id');
$listOrder = $this->state->get('list.ordering');
$listDirn  = $this->state->get('list.direction');
$canOrder  = $user->authorise('core.edit.state', 'com_tasks');
			...
			<table class="table table-striped" id="taskList">
				...
				<tr>
					...
					<?php endif; ?>
									...
									<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_TASKS_TASKS_ID', 'a.`id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_TASKS_TASKS_TASK', 'a.`task`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_TASKS_TASKS_USER', 'a.`user`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_TASKS_TASKS_DEADLINE', 'a.`deadline`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canCreate  = $user->authorise('core.create', 'com_tasks');
					$canEdit    = $user->authorise('core.edit', 'com_tasks');
