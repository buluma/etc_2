 ...
 * @since  1.6
 */
class PhotosTablephoto extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'PhotosTablephoto', array('typeAlias' => 'com_photos.photo'));
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_photos.photo.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_photos/access.xml',
				"/access/section[@name='photo']/"
			);
			$default_actions = JAccess::getAssetRules('com_photos.photo.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_photos.photo.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_photos');
