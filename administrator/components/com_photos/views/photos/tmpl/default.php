...
$document->addStyleSheet(JUri::root() . 'administrator/components/com_photos/assets/css/photos.css');
$document->addStyleSheet(JUri::root() . 'media/com_photos/css/list.css');
//datatables
...
$canOrder  = $user->authorise('core.edit.state', 'com_photos');
$saveOrder = $listOrder == 'a.`ordering`';

if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_photos&task=photos.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'photoList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

$sortFields = $this->getSortFields();
?>

<form action="<?php echo JRoute::_('index.php?option=com_photos&view=photos'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<table class="table table-striped" id="photoList">
				...
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PHOTOS_PHOTOS_STORE', 'a.`store`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PHOTOS_PHOTOS_STORE_ID', 'a.`store_id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PHOTOS_PHOTOS_STORE_SERVER_ID', 'a.`store_server_id`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PHOTOS_PHOTOS_CREATED_ON', 'a.`created_on`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PHOTOS_PHOTOS_COORDINATES', 'a.`coordinates`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PHOTOS_PHOTOS_CLIENT_MODIFIED_DATE', 'a.`client_modified_date`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo JHtml::_('searchtools.sort',  'COM_PHOTOS_PHOTOS_FIRST_INSERT_DATE', 'a.`first_insert_date`', $listDirn, $listOrder); ?>
				</th>
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canCreate  = $user->authorise('core.create', 'com_photos');
					$canEdit    = $user->authorise('core.edit', 'com_photos');
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'photos.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
