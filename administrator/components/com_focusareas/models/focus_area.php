 ...
 * @since  1.6
 */
class FocusareasModelFocus_area extends JModelAdmin
{
	/**
	 * @var      string    The prefix to use with controller messages.
	 * @since    1.6
	 */
	protected $text_prefix = 'COM_FOCUSAREAS';

	/**
	 * @var   	string  	Alias to manage history control
	 * @since   3.2
	 */
	public $typeAlias = 'com_focusareas.focus_area';
	 ...
	 * @since    1.6
	 */
	public function getTable($type = 'Focus_area', $prefix = 'FocusareasTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm(
			'com_focusareas.focus_area', 'focus_area',
			array('control' => 'jform',
				'load_data' => $loadData
			)
		);
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_focusareas.edit.focus_area.data', array());
	...
	/**
	 * Method to duplicate an Focus_area
	 *
	...
	public function duplicate(&$pks)
	{
		...
		// Access checks.
		if (!$user->authorise('core.create', 'com_focusareas'))
		{
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			{
				$db = JFactory::getDbo();
				$db->setQuery('SELECT MAX(ordering) FROM #__focusareas');
				$max             = $db->loadResult();
