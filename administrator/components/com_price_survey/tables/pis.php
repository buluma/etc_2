 ...
 * @since  1.6
 */
class Price_surveyTablepis extends JTable
{
	...
	{
		JObserverMapper::addObserverClassToClass('JTableObserverContenthistory', 'Price_surveyTablepis', array('typeAlias' => 'com_price_survey.pis'));
		parent::__construct('#__price_survey', 'id', $db);
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		// Support for empty date field: inputdate
		if($array['inputdate'] == '0000-00-00' )
		{
			$array['inputdate'] = '';
		}
		...
		if (!JFactory::getUser()->authorise('core.admin', 'com_price_survey.pis.' . $array['id']))
		{
			$actions         = JAccess::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_price_survey/access.xml',
				"/access/section[@name='pis']/"
			);
			$default_actions = JAccess::getAssetRules('com_price_survey.pis.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_price_survey.pis.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId(JTable $table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_price_survey');
